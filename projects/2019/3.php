...
<main>
    <section class="project p-4">
        <div class="text-line-wrapper mt-3">
            <h1 class="project-h1">Przedszkole nr. 16 Chorzów</h1>
                ...
                <div class="row">
                    <div class="col-12 col-xl-4">
                        <div class="project-img-wrapper">
                            <img class="project-img" src="../../assets/img/projects/2019/3/1.png" />
                        </div>
                    </div>
                    <div class="col-12 col-xl-4 p-3 p-xl-0">
                        <div class="project-img-wrapper">
                            <img class="project-img" src="../../assets/img/projects/2019/3/2.png" />
                        </div>
                    </div>
                    <div class="col-12 col-xl-4 p-3 p-xl-0">
                        <div class="project-img-wrapper">
                            <img class="project-img" src="../../assets/img/projects/2019/3/3.png" />
                        </div>
                    </div>
                </div>
            </div>
