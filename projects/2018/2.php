...
<head>
    ...
    <title>LiftKatowice | Projekt</title>
</head>
<body>
<header class="sticky-top">
    <nav class="navbar bg-own-lightgray navbar-light navbar-expand-lg project-navbar">
        ...
        <div class="collapse navbar-collapse" id="nav-main-menu">
            <ul class="navbar-nav ms-2 ms-lg-auto me-2">
                ...
                <li class="nav-item">
                    <a class="nav-link active ms-lg-1" href="../../#projects">Realizacje</a>
                </li>
                <li class="nav-item dropdown">
...
<main>
    <section class="project p-4">
        <div class="text-line-wrapper mt-3">
            <h1 class="project-h1">Kwitnąca Zagórzyce Dworskie</h1>
            <div class="project-hor-line mb-3"></div>
        </div>
        <div class="project-imgs-wrapper p-4">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-12 col-md-6 col-xxl-3">
                        <div class="project-img-wrapper">
                            <img class="project-img" src="../../assets/img/projects/2018/2/1.png" />
                        </div>
                    </div>
                    <div class="col-12 col-md-6 col-xxl-3 p-3 p-md-0">
                        <div class="project-img-wrapper">
                            <img class="project-img" src="../../assets/img/projects/2018/2/2.png" />
                        </div>
                    </div>
                    <div class="col-12 col-md-6 col-xxl-3 p-3 p-xxl-0">
                        <div class="project-img-wrapper">
                            <img class="project-img" src="../../assets/img/projects/2018/2/3.png" />
                        </div>
                    </div>
                    <div class="col-12 col-md-6 col-xxl-3 p-3 p-xxl-0">
                        <div class="project-img-wrapper">
                            <img class="project-img" src="../../assets/img/projects/2018/2/4.png" />
                        </div>
                    </div>
                </div>
            </div>
            <div class="project-button-wrapper mt-5">
                <a class="project-button-a" href="../../#projects" title="Powrót">
...
<footer class="project-footer bg-own-lightgray">
    <div class="container">
        <div class="row">
