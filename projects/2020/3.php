...
<main>
    <section class="project p-4">
        <div class="text-line-wrapper mt-3">
            <h1 class="project-h1">Kler Katowice</h1>
                ...
                <div class="row">
                    <div class="col-12 col-md-6 col-xxl-3">
                        <div class="project-img-wrapper">
                            <img class="project-img" src="../../assets/img/projects/2020/3/1.png" />
                        </div>
                    </div>
                    <div class="col-12 col-md-6 col-xxl-3 p-3 p-md-0">
                        <div class="project-img-wrapper">
                            <img class="project-img" src="../../assets/img/projects/2020/3/2.png" />
                        </div>
                    </div>
                    <div class="col-12 col-md-6 col-xxl-3 p-3 p-xxl-0">
                        <div class="project-img-wrapper">
                            <img class="project-img" src="../../assets/img/projects/2020/3/3.png" />
                        </div>
                    </div>
                    <div class="col-12 col-md-6 col-xxl-3 p-3 p-xxl-0">
                        <div class="project-img-wrapper">
                            <img class="project-img" src="../../assets/img/projects/2020/3/4.png" />
                        </div>
                    </div>
                </div>
            </div>
